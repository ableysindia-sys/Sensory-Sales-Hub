...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      makeProduct("6x4 Ballpool", "ballpool", "Large 6x4 foot ballpool for group therapy sessions.", "The 6x4 Ballpool accommodates multiple children simultaneously, ideal for group therapy. Reinforced construction withstands institutional use.", { dimensions: "180cm x 120cm x 60cm", material: "PVC-free vinyl, reinforced foam walls", weightCapacity: "200 kg", useCase: "Group therapy, sensory gyms" }, ["Extra-large capacity", "Reinforced wall construction", "Easy-drain floor design", "Anti-microbial coating"], ["Group sensory therapy", "Tactile exploration", "Social interaction therapy", "Motor development"]),
    ],
  },
  {
    slug: "mats",
